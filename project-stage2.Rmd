...
In each model above we predict the probability of win for Donald Trump. Then we consider a threshold in the range $(0,1)$. If the predicted probability >
threshold, then we predict that that Trump w
