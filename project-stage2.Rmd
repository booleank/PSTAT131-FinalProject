...
The results of US general election 2012 was predicted with high accuracy.  

For this project, our goal was to predict the winning candidate in each county for the US general election 2016 from the numeric covariates in the 'census' dataset. Our analysis was performed retrospectively and the winner was known, hence although there were many candidates competing, we designed our response 
as a binary variable where a 'Win' or 'Loss' indicates respectively win or loss for Donald Trump. This specific construction of the response was done to 
facilitate the use of classification models we discussed under supervised learning methods such as: 
...
> **Figure 1**: Scree plot of cumulative and proportion of variance explained for each principal component.
...
Additionally, we analyzed the loading plots for thee first ten principal components to identify the most important covariates.

> **Figure 2**: Loadings plot for the first 10 principal components.
